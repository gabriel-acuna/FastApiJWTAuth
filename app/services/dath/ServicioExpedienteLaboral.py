        ...
        try:
            ...
            if detalle:
                ...
                if detalle[0].id_tipo_docente:
                    t_d = TipoDocenteLOES.obtener(id=detalle[0].id_tipo_docente)
                ...
                if detalle[0].id_categoria_docente:
                    ...
                    categoria_docente = CategoriaDocenteLOSEPSchema(**c_d[0].__dict__)
