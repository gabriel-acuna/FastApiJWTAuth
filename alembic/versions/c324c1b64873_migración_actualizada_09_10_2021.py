"""migración actualizada 09-10-2021

Revision ID: c324c1b64873
Revises: 
Create Date: 2021-08-09 22:05:46.322282
...
def upgrade():
    ...
    sa.Column('categoria_contrato', sa.String(length=50), nullable=False),
    ...
    sa.Column('segundo_segundo', sa.String(length=30), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('tiempo_dedicacion', sa.String(length=50), nullable=False),
    sa.Column('registrado_en', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.Column('actualizado_en', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('tipo_docente', sa.String(length=50), nullable=False),
    sa.Column('registrado_en', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.Column('actualizado_en', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('tipo_token', sa.Enum('acceso', 'solicitud_cambio_calve', name='tipotoken'), nullable=False),
    sa.Column('token', sa.String(), nullable=False),
    sa.Column('usuario_id', postgresql.UUID(), nullable=True),
    sa.Column('generado_en', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
